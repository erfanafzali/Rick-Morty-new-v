...
function Modal({ open, setOpen, title, children  }) {
  ...
  return (
    <div>
      ...
      <div className="absolute gap-y-1 sm:gap-y-2 md:gap-y-3 lg:gap-y-5 top-[20%] sm:top-[26%] bg-slate-600 left-[5%] w-[90%] md:w-[40%] md:left-[30%]  p-1 sm:p-2 md:p-3 lg:p-4 rounded-xl shadow-lg shadow-slate-500 flex flex-col justify-center ">
